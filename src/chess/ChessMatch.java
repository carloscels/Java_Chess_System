...
public class ChessMatch {
    ...
    public boolean [][] possibleMoves(ChessPosition sourcepPosition){
        Position position = sourcepPosition.toPosition();
    ...
    private void validateSourcePosition(Position position) {
        ...
        if(!board.piece(position).isThereAnyPossibleMoves()) {
            throw new ChessExcepition("there is no possible moves for the chose piece");
        }
    }
